...
During initial setup of the vhdl-forge-3v0-claude project, several structural issues were identified that prevent the project from working out-of-the-box. This document details these issues and provides actionable fixes to improve the developer experience.
